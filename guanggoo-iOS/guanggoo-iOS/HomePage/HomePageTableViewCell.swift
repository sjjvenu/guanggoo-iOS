...
class HomePageTableViewCell: UITableViewCell {
    ...
    //last reply name
//    var _lastReplyNameLabel : UILabel!;
//    var lastReplyNameLabel :UILabel {
//        get {
//            guard _lastReplyNameLabel == nil else {
//                return _lastReplyNameLabel;
//            }
//            _lastReplyNameLabel = UILabel.init();
//            _lastReplyNameLabel.textColor = UIColor.black;
//            _lastReplyNameLabel.font = UIFont.systemFont(ofSize: 12);
//            return _lastReplyNameLabel;
//        }
//    }
    //node name
