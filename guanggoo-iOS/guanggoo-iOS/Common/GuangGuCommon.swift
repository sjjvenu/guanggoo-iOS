...
let IPHONE_X = SCREEN_WIDTH == 375 && SCREEN_HEIGHT == 812
let IPHONE_XR = SCREEN_WIDTH == 414 && SCREEN_HEIGHT == 896
let IPHONE_XS = SCREEN_WIDTH == 375 && SCREEN_HEIGHT == 812
let IPHONE_XSMAX = SCREEN_WIDTH == 414 && SCREEN_HEIGHT == 896
let IPHONE_FULLSCREEN = IPHONE_X || IPHONE_XR || IPHONE_XS || IPHONE_XSMAX
